...
class Register extends Component {
    ...
    validate = () => {
        ...
        if (data.branch === '') errors.branch = 'branch can not be blank.';
        ...
        return (
            ...
            <Form onSubmit={this.handleSubmit}>
                ...
                <FormGroup>
                    ...
                    <Input id="branch" value={data.branch} invalid={errors.branch ? true : false} name="branch" onChange={this.handleChange} />
                ...
                onClick={Toastify}>Register</Button>
                  <ToastContainer />
            </Form>
        );
    }
